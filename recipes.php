			...
			<nav class="navbar navbar-inverse homeMargin">
				<div class="container-fluid">
					...
					<ul class="nav navbar-nav menu">
						...
						<li class="myPageStyle"><a href="recipes.php">Recipes</a></li>
				...
				<div class="col-md-8">
						...
						<div class="side">
							<div class="colorSettingsSideBar">
								<span><center>Recipiees</center></span>
							</div>
						</div>
					...
					<div class="post">
						<div class="row">
							<div class="col-md-4">
								<img src="image\food01.jpg" class="img img-thumbnail" style="width: 250px; height: 170px">
							</div>
							<div class="col-md-8">
								<h4 style="font-weight: bold; color: #333">Recipe 1</h4>
								<h6 style="float:right">Date:12/12/2018</h6>
								<br><br>
								<p style="text-align: justify;">An increasing number of CIT's courses include subjects or components that can be studied fully or partially online. Check the course details to find out whether the course you are interested in has online or off-campus components.</p>
							</div>
						</div>
					</div><hr>
					...
					<div class="post">
						<div class="row">
							<div class="col-md-4">
								<img src="image\banner.jpg" class="img img-thumbnail" style="width: 250px; height: 170px">
							</div>
							<div class="col-md-8">
								<h4 style="font-weight: bold; color: #333">Recipe 2</h4>
								<h6 style="float:right">Date:12/12/2018</h6>
								<br><br>
								<p style="text-align: justify;">An increasing number of CIT's courses include subjects or components that can be studied fully or partially online. Check the course details to find out whether the course you are interested in has online or off-campus components.</p>
							</div>
					...
					<div class="post">
						<div class="row">
							<div class="col-md-4">
								<img src="image\baby-food.jpg" class="img img-thumbnail" style="width: 250px; height: 170px">
							</div>
							<div class="col-md-8">
								<h4 style="font-weight: bold; color: #333">Recipe 3</h4>
								<h6 style="float:right">Date:12/12/2018</h6>
								<br><br>
								<p style="text-align: justify;">An increasing number of CIT's courses include subjects or components that can be studied fully or partially online. Check the course details to find out whether the course you are interested in has online or off-campus components.</p>
							</div>
					...
					<div class="post">
						<div class="row">
							<div class="col-md-4">
								<img src="image\01.jpg" class="img img-thumbnail" style="width: 250px; height: 170px">
							</div>
							<div class="col-md-8">
								<h4 style="font-weight: bold; color: #333">Recipe 4</h4>
								<h6 style="float:right">Date:12/12/2018</h6>
								<br><br>
								<p style="text-align: justify;">An increasing number of CIT's courses include subjects or components that can be studied fully or partially online. Check the course details to find out whether the course you are interested in has online or off-campus components.</p>
							</div>
