...
<!--===========================================LEFT SIDE BODY START (WORKING)=================================-->
			<div class="row">
				<div class="col-md-8">
						...
						<h4><b>Address: </b>GPO Box 826 Canberra, ACT 2601</h4>
						<h4><b>Phone Number:</b> +61 2 6207 3188</h4>
						<br>
						<h1>CIT Student Services</h1>
						<h4><b>Email: </b>infoline@cit.edu.au</h4>
						<h4>CIT is a smoke free environment</h4><br>
					
					<img class="img-responsive" src="image\map.png" width: 700px; height: 400px>
				</div>
